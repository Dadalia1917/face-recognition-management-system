...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap('UIProgram/ui_imgs/icons/人脸识别 (1).png'), QtGui.QIcon.Active, QtGui.QIcon.On)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于深度学习的人脸识别信息管理系统"))
        self.label.setText(_translate("MainWindow", "人脸识别信息管理系统"))
        self.groupBox.setTitle(_translate("MainWindow", "操作列表"))
        self.infoEntryBtn.setText(_translate("MainWindow", "信息录入"))
        self.faceRecBtn.setText(_translate("MainWindow", "人脸识别"))
        self.dataManageBtn.setText(_translate("MainWindow", "信息管理"))
